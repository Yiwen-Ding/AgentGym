...
class TrainingArguments:
    ...
    inference_file: str = field(default="./data/train/webshop_train.json", metadata={"help": "Inference dataset."})
...
def main():
    ...
    model = AutoModelForCausalLM.from_pretrained(args.model_train_path, low_cpu_mem_usage=True, torch_dtype=torch.bfloat16)
